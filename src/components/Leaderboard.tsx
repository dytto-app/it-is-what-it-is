            ...
            return (
              <div
                ...
                className={`relative overflow-hidden rounded-3xl transition-all duration-500 transform hover:scale-[1.02] ${
                  isCurrentUser
                    ? `bg-gradient-to-br ${frameStyle.gradient} border-2 ${frameStyle.border} shadow-2xl ring-2 ring-slate-300/70 ring-offset-2 ring-offset-slate-900`
                    : rank <= 3
              ...
              >
                ...
                {isCurrentUser && (
                  <div className="absolute top-3 right-3 bg-gradient-to-r from-slate-300/30 to-zinc-400/30 text-slate-200 px-3 py-1 rounded-full text-xs font-bold border border-slate-300/40 shadow-lg">
                    YOU
                  </div>
                )}
